---
title: "Empathic-dynamics_04-Analyses"
author: "SSK"
format: 
  html:
    toc: TRUE
...
tab_model(lm(manipTreat1 ~ Condition + wave, data))
...
tab_model(lm(manipTreat2_recode ~ Condition + wave, data))
...
#| message: false
#| code-fold: true
tab_model(lm(IRI_PT_4 ~ Condition + wave, data))
...
#| message: false
#| code-fold: true
tab_model(lm(IRI_PT_3 ~ Condition + wave, data))
